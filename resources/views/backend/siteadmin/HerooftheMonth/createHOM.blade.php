    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card" id="entry_div" >
                <div class="card-header text-white card-header-main">{{isset($edit_f) ? 'Update' : 'Add'}} Hero of the Month</div>
                <div class="card-body">
                    @if(session('success'))
                    ...
                    @endif
                    @if(isset($edit_f))
                        <form id="formid" method="POST" action="{{ route('siteadmin.updateHeroOfMonth') }}" enctype="multipart/form-data">
                        @else
                        <form id="formid" method="POST" action="{{ route('siteadmin.storeHeroOfMonth') }}" enctype="multipart/form-data">
                    @endif
