            ...
            <div class="col-md-12">
                ...
                <div class="card" id="entry_div">
                    ...
                    <div class="card-body">
                        ...
                        <form id="formid" method="POST" action="{{ route('siteadmin.updateBOD') }}" enctype="multipart/form-data">
                                ...
                                @endphp
                                    ...
                                    @foreach ($keydata->bodsub as $bodsub)
                                        <div class="col-sm-12">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 mb-btm" id="div{{ $bodsub->id }}">
                                                ...
                                                <div class="col-sm-12 mb-btm" id="div_description{{ $bodsub->id }}">
