            ...
            <div class="card" id="entry_div" >
                ...
                <div class="card-body">
                    ...
                    @csrf
                        ...
                        <input type="hidden" name="departId" value="{{$keydata->departId ?? ''}}">
                        <input type="hidden" name="iectype" value="{{$keydata->iectype ?? ''}}">
                        ...
                        <div class="row mb-3 card-header card-main">
                            ...
                            <div class="row mb-3 pt-3">
                                ...
                                <label for="gallerytype" class="my-1 mr-2">Gallery type<span class="redalert"> *</span></label>
                                 <select class="form-control select2 formselect" name="gallerytype" id="gallerytype" required>
                                    <option value="">Select</option>

                                        @foreach($Gallerytype as $Gallerytypes)
                                            <option value="{{$Gallerytypes->id}}" @if(isset($keydata->id)) {{ $Gallerytypes->id == $keydata->gallerytypeid ? 'selected' : '' }} @endif >{{$Gallerytypes->name}}</option>
                                        @endforeach
                                 </select>
                            ...
                            <div class="row">
                                   <div class="col-sm-12" id="alertTypeDiv" style="display: none;">
                                    <label for="departId" class="my-1 mr-2">Scheme type<span class="redalert"> *</span></label>
                                 <select class="form-control select2" name="departId" id="departId" required>
                                   @foreach ($departments as $department)
                                        @foreach ($department->office_sub as $office_sub)
                                            <option value="{{$department->id}}" @if(isset($keydata->id)) {{ $department->id == $keydata->departId ? 'selected' : '' }} @endif>{{$office_sub->title}}</option>
                                        @endforeach
                                    @endforeach
                                </select>
                            ...
                            <div class="row">
                                   <div class="col-sm-12" id="iectypeDiv" style="display: none;">
                                    <label for="iectype" class="my-1 mr-2">IEC type<span class="redalert"> *</span></label>
                                <select class="form-control select2" name="iectype" id="iectype" required>
                                    <option value="0" @if(isset($edit_f)) @if(old('iectype', $keydata->iectype) == '0') selected  @endif @endif>Select</option>
                                    <option value="1" @if(isset($edit_f)) @if(old('iectype', $keydata->iectype) == '1') selected  @endif @endif>COMMUNICABLE DISEASE</option>
                                    <option value="2" @if(isset($edit_f)) @if(old('iectype', $keydata->iectype) == '2') selected  @endif @endif>NON-COMMUNICABLE DISEASE</option>
                                    <option value="3" @if(isset($edit_f)) @if(old('iectype', $keydata->iectype) == '3') selected  @endif @endif>MOTHER AND CHILD</option>
                                    <option value="4" @if(isset($edit_f)) @if(old('iectype', $keydata->iectype) == '4') selected  @endif @endif>MISCELLANEOUS</option>
...
// });
 ...
 $('#gallerytype').on('change', function(e) {
