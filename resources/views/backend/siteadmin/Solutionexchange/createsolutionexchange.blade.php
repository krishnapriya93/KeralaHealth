    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card @if($errors->any()) @else  @endif" id="entry_div">
                <div class="card-header text-white card-header-main">{{isset($edit_f) ? 'Update' : 'Add'}} Solution Exchange</div>
                <div class="card-body">
                    @if($errors->any())
                    ...
                    @if(isset($edit_f))
                    <form id="formid" method="POST" action="{{ route('siteadmin.surveyupdate') }}" enctype="multipart/form-data">
                        @else
                        <form id="formid" method="POST" action="{{ route('siteadmin.surveystore') }}" enctype="multipart/form-data">
                            @endif
                            ...
                            <div class="row mb-3 card-header card-main">
                                ...
                                <div class="row div_lan1 mb-3">
                                    <div class="col-sm-12 mb-btm" id="div{{$langs->id}}">
                                        <label class="my-1 mr-2" for="inlineFormCustomSelectPref">Question {{$langs->name}} <span class="redalert"> *</span></label>
                                ...
                                <div id="extra-fields-container{{$langs->id}}"></div> <!-- Add this line -->
                                ...
                                <div class="row div_lan1 mb-3">
                                    <div class="col-sm-12 mb-btm" id="div_content{{$langs->id}}">
                                        ...
                                        <textarea id="con_title{{$langs->id}}" class="form-control ckeditormilestone @error('con_title') is-invalid @enderror" name="con_title[{{$i}}]" autocomplete="language" placeholder="Enter Content in {{$langs->name}} here" autofocus>{{strip_tags(htmlspecialchars_decode($langs->content))}}</textarea>
                                    </div><br />
                                </div>
