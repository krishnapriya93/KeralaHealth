...
<aside class="sidebar-nav-wrapper">
  ...
  @elseif(Auth::user()->role_id==2)
   ...
   <a href="{{route('acsadminhome')}}">
   @elseif(Auth::user()->role_id==8)
   <a href="{{route('officerhome')}}">
   @elseif(Auth::user()->role_id==9)
   <a href="{{route('editorhome')}}">
  @endif
      <img src="{{asset('assets/backend/log-n.png')}}" class="logo-size" alt="logo" />
    </a>
  </div>
      ...
      <li class="nav-item nav-item-has-children main-active">
        ...
        <ul id="ddmenu_1" class="collapse show dropdown-nav ">
          <li class="sub-active">
            ...
            @elseif(Auth::user()->role_id==7)
              <a href="{{route('acsadminhome')}}"> Main Dashboard </a>
            @elseif(Auth::user()->role_id==8)
              <a href="{{route('officerhome')}}"> Main Dashboard </a>
            @elseif(Auth::user()->role_id==9)
              <a href="{{route('editorhome')}}"> Main Dashboard </a>  
            @endif
          </li>
        </ul>
      </li>
