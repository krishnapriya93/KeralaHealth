            ...
            <div class="card">
                ...
                <div class="card-body">
                  @if(session('success'))
                   ...
                   @if(isset($edit_f))
                    <form id="formiid" method="POST" action="{{ route('masteradmin.updategallerytype') }}" enctype="multipart/form-data">
                    @else
                    <form id="formiid" method="POST" action="{{ route('masteradmin.storegallerytype') }}" enctype="multipart/form-data">
                    @endif
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>{{ $result->name }}</td>
                        <td>
                            <a class="btn btn-primary btn-sm" href="{{ route('masteradmin.editgaltype',\Crypt::encryptString($result->id)) }}">Edit</a>
                            <a class="btn btn-danger btn-sm" href="{{ route('masteradmin.deletegaltype',\Crypt::encryptString($result->id)) }}">Delete</a>
                        </td>
                    </tr>   
                    @endforeach    
                    </tbody>    
