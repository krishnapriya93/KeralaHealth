...
<div class="container-fluid dashboard_bg  min-vh-100">
    ...
    <div class="row pt-3 pb-2" id="bread-row">
        <div class="col-12">
            <span class="h4"> <i class="fas fa-folder-open"></i> &nbsp; Upload Suggestion Items</span>
        </div> <!-- ./col12 -->
    ...
    <div class="row py-2" id="warning-row">
        <div class="col-12">
            <div class="alert alert-success" role="alert">
                <span class="text-primary">{{'Upload images for Suggest Stills'}}</span>
            </div> <!-- ./alert -->
        </div>
    </div><!-- ./row -->
    <div class="row py-2">
        ...
        <div class="row mt-2">
            ...
            <div class="col-lg-3 p-2 d-flex justify-content-center">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        @php
                            $filePath = '/assets/backend/uploads/Suggestionitem/' . $res->image;
                    ...
                    <div class="card-footer">
                        <input type="hidden" id="poster_path" name="poster_path" value="{{asset('/assets/backend/uploads/Suggestionitem/'.$res->image) }}">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.delete_pic_btn').on('click', function(e) {
            ...
            // alert(usertype+"ss");
            var action_url = "/officer/deletesuggestionupload/" + element_id;
...
$('button').on('click',function(){
    ...
    var actionurl = '/officer/suggattachmtupload/' + hidid;
...
.then(willDelete => {
  if (willDelete) {
    ...
    window.location.href = "/officer/viewsuggestionitem/" + hidid; 
