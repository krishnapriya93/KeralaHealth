                                            ...
                                            <div class="pbmit-blog-classic-inner">
                                                ...
                                                <div class="tabx mt-3">
                                                    <div class="tabs-container">
                                                        ...
                                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                            <li class="nav-item me-1" role="presentation">
                                                                <button class="nav-link active ms-0" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" value="1">Home</button>
                                                            </li>
                                                            @php $submenuarry =[]; @endphp

                                                            @if(empty($officelists->id))
                                                            ...
                                                            @php $submenuarry[] = $submenu->id;
                                                            @endphp
                                                            <li class="nav-item me-1" role="presentation">
                                                                <button class="nav-link ms-0"
                                                                    id="tab-btn-{{$submenu->id}}"
                                                                    data-bs-toggle="tab"
                                                                    data-bs-target="#tab-content-{{$submenu->id}}"
                                                                    type="button"
                                                                    role="tab"
                                                                    value="{{$submenu->id}}">
                                                                    {{ $dep_submenu->title }}
                                                    ...
                                                    <div class="tab-content mt-3" id="myTabContent">
                                                        ...
                                                        <div class="tab-pane fade" id="practice" role="tabpanel">
                                                            <div class="pbmit-entry-content">
                                                                <div class="square">
                                                                    ...
                                                                    @if($ArticleDepartment->articletype_id == 8)
                                                                    ...
                                                                    <aside class="widget widget-recent-post">
                                                                        ...
                                                                        <ul class="recent-post-list">
                                                                            <li class="recent-post-list-li">
                                                                                ...
                                                                                @php
                                                                                $imagePath = '/assets/backend/uploads/articles/' . $articleval_sub->file;
                                                                                @endphp

                                                                                <a class="recent-post-thum" href="{{ route('main.articledetail', ['title' => $FormatTitle, 'id' => Crypt::encryptString($ArticleDepartment->id) ]) }}">
                                                                                    <img src="{{ !empty($articleval_sub->file) && file_exists(public_path($imagePath)) 
                                                                                                ? asset($imagePath) 
                                                                                                : asset('/assets/frontend/images/patient.png') }}"
                                                                                        class="img-fluid"
                                                                                        alt="">
                                                                                </a>
                                                        ...
                                                        <div class="tab-pane fade" id="tab-content-{{ $submenu->id }}" role="tabpanel" aria-labelledby="tab-btn-{{ $submenu->id }}">
                                                            <div class="pbmit-entry-content">
                                                                <div class="square">
                                                                    @php $hasArticles = false; @endphp

                                                                    @foreach($ArticleDepartments as $ArticleDepartment)
                                                                    @if ($ArticleDepartment->submenu == $submenu->id && $ArticleDepartment->articleval_sub && count($ArticleDepartment->articleval_sub) > 0)

                                                                    @php $hasArticles = true; @endphp
                                                        ...
                                                        : asset('/assets/frontend/images/patient.png') }}"
                                                                                ...
                                                                                <div class="pbmit-rpw-content">
                                                                                    <span class="pbmit-rpw-date">
                                                                                        <a href="{{ route('main.articledetail', ['title' => $FormatTitle, 'id' => Crypt::encryptString($ArticleDepartment->id)]) }}">
                                                                                            {{ \Carbon\Carbon::parse($ArticleDepartment->created_at)->format('F d, Y') }}
                                                                                        </a>
                                                                                    </span>
                                                                                    <span class="pbmit-rpw-title">
                                                                                        <a href="{{ route('main.articledetail', ['title' => $FormatTitle, 'id' => Crypt::encryptString($ArticleDepartment->id)]) }}">
                                                                    ...
                                                                    @if (!$hasArticles)
                                                                    <p class="text-muted">No articles found for this submenu (ID: {{ $submenu->id }}).</p>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        <aside class="sidebar">
                            <aside class="widget widget-recent-post">
                                ...
                                <ul class="recent-post-list">
                                    ...
                                    @foreach($R_ArticleDepartments as $R_ArticleDepartment)

                                    @foreach($R_ArticleDepartment->articleval_sub as $articleval_sub)
                                    @php $FormatTitle = preg_replace('/[^A-Za-z0-9_]/', '', str_replace(' ', '_', $articleval_sub->title)) @endphp
                                    ...
                                    <li class="recent-post-list-li">
                                        ...
                                        <a class="recent-post-thum" href="{{ route('main.articledetail', ['title' => $FormatTitle, 'id' => Crypt::encryptString($R_ArticleDepartment->id) ]) }}">
                                            <img src="{{ !empty($articleval_sub->file) && file_exists(public_path($imagePath)) 
                                                        ? asset($imagePath) 
                                                        : asset('/assets/frontend/images/patient.png') }}"
                                                class="img-fluid"
                                        ...
                                        <div class="pbmit-rpw-content">
                                            <span class="pbmit-rpw-date">
                                                <a href="{{ route('main.articledetail', ['title' => $FormatTitle,'id' => Crypt::encryptString($R_ArticleDepartment->id) ]) }}">{{ \Carbon\Carbon::parse($ArticleDepartment->created_at)->format('F d, Y') }}
                                                </a>
                                            </span>
                                            <span class="pbmit-rpw-title">
                                                <a href="{{ route('main.articledetail', ['title' => $FormatTitle,'id' => Crypt::encryptString($R_ArticleDepartment->id) ]) }}">{{$articleval_sub->title}}</a>
                                            </span>
                                        </div>
                                    </li>
                                    @php $count++; @endphp
