                ...
                <div class="pbmit-title-bar-content-inner">
                    <div class="pbmit-tbar">
                        <div class="pbmit-tbar-inner container">
                            <h1 class="pbmit-tbar-title">{{  App\Http\Controllers\FrontendController::getSiteControlLabel('organization') ?? 'Organization' }}</h1>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="d-xl-flex align-items-center justify-content-between">
                    <div class="pbmit-heading-subheading">
                        <!-- <h2 class="{{ isset($sessionbil) && $sessionbil == 1 ? 'pbmit-title' : 'pbmit-title1' }}">{{  App\Http\Controllers\FrontendController::getSiteControlLabel('organization') ?? 'Organization' }}</h2> -->
                    </div>
                    <div class="pbmit-sortable-list pbmit-sortable-list-style-1">
                        <ul class="pbmit-sortable-list-ul">
                            ...
                            <li><a href="#" class="pbmit-sortable-link" data-sortby="health" value="2">{{  App\Http\Controllers\FrontendController::getSiteControlLabel('healthorg') ?? 'Health organization' }}</a></li>
                            <li><a href="#" class="pbmit-sortable-link" data-sortby="ayush" value="3">{{  App\Http\Controllers\FrontendController::getSiteControlLabel('ayushorg') ?? 'Ayush organization' }}</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="pbmit-element-posts-wrapper row" id="office-container">
                    <!-- Add a data-category attribute to each article for easy filtering -->
                     @foreach($officelists as $officelist)
                        ...
                        <!-- @php $FormatTitle = preg_replace('/[^A-Za-z0-9_]/', '', str_replace(' ', '_', $office_sub->title)) @endphp -->
                        @php
$FormatTitle = preg_replace('/[^\p{Malayalam}A-Za-z0-9_]/u', '', str_replace(' ', '_', $office_sub->title));
@endphp
...
<script type="text/javascript">
    ...
    $(".pbmit-sortable-link").on("click", function (e) {
        ...
        $.ajax({
        url: "{{ route('orgnazationsort') }}", // Replace with your actual route URL
