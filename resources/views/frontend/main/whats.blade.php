                                                ...
                                                <div class="pbmit-ihbox-contents w-100">
                                                    <div class="news1">
                                                        <ul>
                                                            ...
                                                            <li><a href="{{ route('main.news-detail') }}">Lorem ipsum dolor sit amet consectetur ghjgfty elit. Ratione vitae enim tempore repellendus. 
                                                                    Repellendus itaque repellat amet voluptas!
                                                                    <br>
                                                                    <span class="pbmit-meta pbmit-meta-date"><i class="pbmit-base-icon-calendar-3"></i>25 July 2023</span>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    ...
                                                    <div class="news1">
                                                        <ul>
                                                            <li class="img-ico"><img src="{{asset('assets/frontend/images/mic.png')}}" alt=""></li>
                                                            <li><a href="{{ route('main.news-detail') }}">Lorem ipsum dolor sit ametfty elit. Ratione vitae enim tempore repellendus. 
                                                                    Repellendus itaque repellat amet voluptas!
                                                                    <br>
                                                                    <span class="pbmit-meta pbmit-meta-date"><i class="pbmit-base-icon-calendar-3"></i>25 July 2023</span>
                                                                </a>
                                                    ...
                                                    <div class="news1">
                                                        <ul>
                                                            <li class="img-ico"><img src="{{asset('assets/frontend/images/mic.png')}}" alt=""></li>
                                                            <li><a href="{{ route('main.news-detail') }}">Lorem ipsum dolor sit amet consectetur ghjgfty elit.  hnnxfbe hturthsy45wRatione vitae enim tempore repellendus. 
                                                                    Repellendus itaque repellat amet voluptas!
                                                                    <br>
                                                                    <span class="pbmit-meta pbmit-meta-date"><i class="pbmit-base-icon-calendar-3"></i>25 July 2023</span>
                                                                </a>
                        ...
                        <div class="col-md-12 col-lg-3 blog-left-col">
                            <aside class="sidebar">
                                <aside class="widget widget-recent-post">
                                    <h2 class="widget-title">New Announcements</h2>
