                ...
                <div class="pbmit-title-bar-content-inner">
                    <div class="pbmit-tbar">
                        <div class="pbmit-tbar-inner container">
                            <h1 class="pbmit-tbar-title">Brochure</h1>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12 col-lg-3 blog-left-col">
                        <aside class="sidebar">
                            <aside class="widget widget-recent-post">
                                <h2 class="widget-title">Related Brochure</h2>
                                    ...
                                    <li class="recent-post-list-li">
                                        <div class="pbmit-rpw-content">
                                            <span class="pbmit-rpw-date">
                                                <a href="{{ route('Brouchers', ['id' => Crypt::encryptString($broucher->id)]) }}">{{ \Carbon\Carbon::parse($broucher->created_at)->format('F d, Y') }}</a>
                                            </span>
                                            <span class="pbmit-rpw-title">
                                                <a href="{{ route('Brouchers', ['id' => Crypt::encryptString($broucher->id)]) }}">{{$gallery_sub->title ?? ''}}</a>
                                            </span>
                                        </div>
                                    </li>
                                    @endforeach
