...
class SbudashboardController extends Controller
{
    ...
    {
        $data = dashboardcategory::with(['dashboardcategorie_sub' => function ($query) {}])->with(['sbutypesub' => function ($query) {}])->get();

        $breadcrumb = [
            0 => ['title' => 'Home', 'message' => 'Home', 'status' => 0, 'link' => '/masteradminhome'],
            1 => ['title' => 'Dashboard category type', 'message' => 'Dashboard category type', 'status' => 1],
        ];
    ...
    public function createdashboardcategory()
    {
        ...
        $breadcrumb = [
            0 => ['title' => 'Home', 'message' => 'Home', 'status' => 0, 'link' => '/masteradminhome'],
            1 => ['title' => 'Dashboard category', 'message' => 'Dashboard category', 'status' => 0, 'link' => '/planning/dashboardcategory'],
            2 => ['title' => 'Create Dashboard category', 'message' => 'Create Dashboard category', 'status' => 1],
        ];
        $breadcrumbarr = app('App\Http\Controllers\Commonfunctions')->bread_crump_maker($breadcrumb);
        $navbar = app('App\Http\Controllers\Commonfunctions')->componentpermissionsetng();
        $user = app('App\Http\Controllers\Commonfunctions')->userinfo();
        ...
        $Sbu_s = Sbutype::with(['sbutypesub' => function ($query) {}])->where('dashboard_view', 1)->get();
    ...
    public function editdashboardcatgry($id)
    {
        ...
        $breadcrumb = [
            0 => ['title' => 'Home', 'message' => 'Home', 'status' => 0, 'link' => '/masteradminhome'],
            1 => ['title' => 'Dashboardcategory', 'message' => 'Dashboardcategory', 'status' => 0, 'link' => '/planning/dashboardcategory'],
            2 => ['title' => 'Edit Dashboardcategory', 'message' => 'Edit Dashboardcategory', 'status' => 1],
        ];
        $breadcrumbarr = app('App\Http\Controllers\Commonfunctions')->bread_crump_maker($breadcrumb);
        $navbar = app('App\Http\Controllers\Commonfunctions')->componentpermissionsetng();
        $user = app('App\Http\Controllers\Commonfunctions')->userinfo();
    ...
    public function sbudashboard(Request $request)
    {
        $breadcrumb = [
            0 => ['title' => 'Home', 'message' => 'Home', 'status' => 0, 'link' => '/masteradminhome'],
            1 => ['title' => 'Dashboard', 'message' => 'Dashboard', 'status' => 1],
        ];
    ...
    public function details_dashboard_catgry(Request $request)
    {
        ...
        } elseif ($org_table_name = 'gengrowthdashboards') {
    ...
    public function createdashboard()
    {
        ...
        $breadcrumb = [
            0 => ['title' => 'Home', 'message' => 'Home', 'status' => 0, 'link' => '/masteradminhome'],
            1 => ['title' => 'Dashboard', 'message' => 'Dashboard', 'status' => 0, 'link' => '/planning/sbudashboard'],
            2 => ['title' => 'Create Dashboard', 'message' => 'Create Dashboard', 'status' => 1],
        ];
        $breadcrumbarr = app('App\Http\Controllers\Commonfunctions')->bread_crump_maker($breadcrumb);
        $navbar = app('App\Http\Controllers\Commonfunctions')->componentpermissionsetng();
        $user = app('App\Http\Controllers\Commonfunctions')->userinfo();
    ...
    public function sectioncontactus()
    {
        ...
        $breadcrumb = [
            0 => ['title' => 'Home', 'message' => 'Home', 'status' => 0, 'link' => '/planninghome'],
            1 => ['title' => 'Section contact us', 'message' => 'Section contact us', 'status' => 1],
        ];
        $breadcrumbarr = app('App\Http\Controllers\Commonfunctions')->bread_crump_maker($breadcrumb);
        $navbar = app('App\Http\Controllers\Commonfunctions')->componentpermissionsetng();
        $user = app('App\Http\Controllers\Commonfunctions')->userinfo();
    ...
    public function createsectioncontactus()
    {
        ...
        $breadcrumb = [
            0 => ['title' => 'Home', 'message' => 'Home', 'status' => 0, 'link' => '/planninghome'],
            1 => ['title' => 'Section contact us', 'message' => 'Section contact us', 'status' => 0, 'link' => '/planning/sectioncontactus'],
            2 => ['title' => 'Create Section contact us', 'message' => 'Create Section contact us', 'status' => 1],
        ];
        $breadcrumbarr = app('App\Http\Controllers\Commonfunctions')->bread_crump_maker($breadcrumb);
        $navbar = app('App\Http\Controllers\Commonfunctions')->componentpermissionsetng();
        $user = app('App\Http\Controllers\Commonfunctions')->userinfo();
    ...
    public function editsectioncontactus($id)
    {
        ...
        $breadcrumb = [
            0 => ['title' => 'Home', 'message' => 'Home', 'status' => 0, 'link' => '/planninghome'],
            1 => ['title' => 'Section contact us', 'message' => 'Section contact us', 'status' => 0, 'link' => '/planning/sectioncontactus'],
            2 => ['title' => 'Edit Section contact us', 'message' => 'Edit Section contact us', 'status' => 1],
        ];
