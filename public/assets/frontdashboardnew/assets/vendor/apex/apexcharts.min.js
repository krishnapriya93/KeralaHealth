    ...
    var x = function() {
        ...
        m = function() {
            ...
            return r(t, [{
                ...
                value: function(t) {
                    ...
                    var T, M = A.config.stroke.dashArray;
                ...
                value: function(t, e) {
                    ...
                    } else "none" !== i.config.states.active.filter.type && ("none" === i.config.states.hover.filter.type || i.globals.isTouchDevice ? a.getDefaultFilter(t, s) : (g = i.config.states.hover.filter, a.applyFilter(t, s, g.type, g.value)));
            ...
            return r(t, [{
                ...
                value: function(t, e) {
                    ...
                    if (this.annoCtx.invertAxis) {
                        ...
                        var n;
                        n = s.config.yaxis[e.yAxisIndex].logarithmic ? (a = new y(this.annoCtx.ctx).getLogVal(a, e.yAxisIndex)) / s.globals.yLogRatio[e.yAxisIndex] : (a - s.globals.minYArr[e.yAxisIndex]) / (s.globals.yRange[e.yAxisIndex] / s.globals.gridHeight), i = s.globals.gridHeight - n, !e.marker || void 0 !== e.y && null !== e.y || (i = 0), s.config.yaxis[e.yAxisIndex] && s.config.yaxis[e.yAxisIndex].reversed && (i = n)
                    }
        ...
        z = function() {
            ...
            return r(t, [{
                ...
                key: "sparkline",
                value: function(t) {
                    return this.hideYAxis(), x.extend(t, {
                        grid: {
                            show: !1,
                            padding: {
                                left: 0,
            ...
            return r(t, [{
                ...
                value: function(t, e) {
                    ...
                    return e && !s && (s = e.config.series), a && s.length !== t.yaxis.length && s.length && (t.yaxis = s.map((function(e, a) {
                        ...
                        return r.show = !1, r
                    }))), a && s.length > 1 && (s.length, t.yaxis.length), t
                }
            }, {
        ...
        O = function() {
            ...
            return r(t, [{
                ...
                value: function(t) {
                    ...
                    for (var x = 0; x < a.x.length; x++)
                        if (g = a.x[x] + d.offsetX, u = a.y[x] + d.offsetY + l, !isNaN(g)) {
                            ...
                            "bubble" === h.config.chart.type ? (v = y(b = h.globals.seriesZ[s][p]), u = a.y[x], u = new D(this.ctx).centerTextInBubble(u, s, p).y) : void 0 !== b && (v = y(b)), this.plotDataLabelsText({
                                x: g,
                                y: u,
                                text: v,
                                i: s,
                ...
                value: function(t, e) {
                    ...
                    return a.dropShadow.enabled && new v(this.ctx).dropShadow(l, a.dropShadow), l
                }
            }, {
            ...
            return r(t, [{
                ...
                value: function(t) {
                    ...
                    for (var c = function() {
                        ...
                        if (this.twoDSeries = [], this.twoDSeriesX = [], this.threeDSeries = [], void 0 === t[d].data) return;
                ...
                value: function(t) {
                    ...
                    })), i.labels = Array.from(new Set(i.labels.map(JSON.stringify)), JSON.parse)), e.xaxis.convertedCatToNumeric && (new z(e).convertCatToNumericXaxis(e, this.ctx, i.seriesX[0]), this._generateExternalLabels(t))) : this._generateExternalLabels(t)
                }
            }, {
        ...
        B = function() {
            ...
            return r(t, [{
                key: "getLabel",
                value: function(t, e, i, a) {
                    var s, r, o = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : [],
                        n = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : "12px",
                        l = !(arguments.length > 6 && void 0 !== arguments[6]) || arguments[6],
                        h = this.w,
                        c = void 0 === t[a] ? "" : t[a],
                        d = c,
                        g = h.globals.xLabelFormatter,
                        u = h.config.xaxis.labels.formatter,
                        p = !1,
                        f = new T(this.ctx),
                        x = c;
                    l && (d = f.xLabelFormat(g, c, x, {
                        i: a,
                    ...
                    })), p = r === s, i = e[a].position, d = e[a].value) : "datetime" === h.config.xaxis.type && void 0 === u && (d = ""), void 0 === d && (d = ""), d = Array.isArray(d) ? d : d.toString();
                    var b = new m(this.ctx),
                        v = {};
                    v = h.globals.rotateXLabels && l ? b.getTextRects(d, parseInt(n, 10), null, "rotate(".concat(h.config.xaxis.labels.rotate, " 0 0)"), !1) : b.getTextRects(d, parseInt(n, 10));
                    var y = !h.config.xaxis.labels.showDuplicates && this.ctx.timeScale;
                    return !Array.isArray(d) && (0 === d.indexOf("NaN") || 0 === d.toLowerCase().indexOf("invalid") || d.toLowerCase().indexOf("infinity") >= 0 || o.indexOf(d) >= 0 && y) && (d = ""), {
                        x: i,
                        text: d,
                        textRect: v,
                        isBold: p
                ...
                value: function(t) {
                    ...
                    h.push(l.config.chart.toolbar.export.csv.headerCategory), "boxPlot" === l.config.chart.type ? (h.push("minimum"), h.push("q1"), h.push("median"), h.push("q3"), h.push("maximum")) : "candlestick" === l.config.chart.type ? (h.push("open"), h.push("high"), h.push("low"), h.push("close")) : "rangeBar" === l.config.chart.type ? (h.push("minimum"), h.push("maximum")) : i.map((function(t, e) {
                        ...
                        l.globals.axisCharts ? function(t, e) {
                            ...
                            var n
                        }(t, e) : ((h = []).push(l.globals.labels[e].split(r).join("")), h.push(g[e]), c.push(h.join(r)))
        ...
        _ = function() {
            ...
            return r(t, [{
                ...
                value: function(t, e) {
                    ...
                    t > e ? e = t + .1 : t === e && (t = 0 === t ? 0 : t - .5, e = 0 === e ? 2 : e + .5);
                    var n = [];
                ...
                value: function(t, e, i) {
                    t || (t = this);
                    var a = t.w;
                    if (a.globals.isMultipleYAxis || a.globals.collapsedSeries.length) return e;
                ...
                value: function(t, e) {
                    ...
                    if (void 0 !== t || void 0 !== e) {
                        if (!(i.config.xaxis.convertedCatToNumeric && (t < 1 && (t = 1, e = i.globals.dataPoints), e - t < 2))) {
                            ...
                            i.config.chart.zoom.autoScaleYaxis && (o = new _(this.ctx).autoScaleY(this.ctx, o, {
                                xaxis: a
        ...
        gt = function() {
            ...
            return r(t, [{
                ...
                value: function(t) {
                    ...
                    null !== p && (a[e].querySelector(".apexcharts-tooltip-text-z-label").innerHTML = l.config.tooltip.z.title, a[e].querySelector(".apexcharts-tooltip-text-z-value").innerHTML = void 0 !== p ? p : ""), o && f[0] && (null == c || l.globals.ancillaryCollapsedSeriesIndices.indexOf(e) > -1 || l.globals.collapsedSeriesIndices.indexOf(e) > -1 ? f[0].parentNode.style.display = "none" : f[0].parentNode.style.display = l.config.tooltip.items.display)
                }
            }, {
                ...
                value: function(t) {
                    ...
                    var d = r;
                    return r = a.globals.isXNumeric && "datetime" === a.config.xaxis.type ? new T(this.ctx).xLabelFormat(a.globals.ttKeyFormatter, d, d, {
                        i: void 0,
                        dateFormatter: new I(this.ctx).formatDate,
                        w: this.w
            ...
            return r(t, [{
                ...
                value: function(t) {
                    ...
                    if (null !== i.xaxisTooltip && 0 !== i.xcrosshairsWidth) {
                        ...
                        if (t -= i.xaxisTooltip.getBoundingClientRect().width / 2, !isNaN(t)) t += e.globals.translateX, a = new m(this.ctx).getTextRects(i.xaxisTooltipText.innerHTML), i.xaxisTooltipText.style.minWidth = a.width + "px", i.xaxisTooltip.style.left = t + "px", i.xaxisTooltip.style.top = s + "px"
                    }
                }
            }, {
        ...
        bt = function() {
            ...
            return r(t, [{
                ...
                value: function(t) {
                    ...
                    }, i.e = s, !i.tooltipUtil.hasBars() || r.globals.comboCharts || i.isBarShared || this.tConfig.onDatasetHover.highlightDataSeries && new N(e).toggleSeriesOnHover(s, s.target.parentNode), i.fixedTooltip && i.drawFixedTooltipRect(), r.globals.axisCharts ? i.axisChartsTooltips({
                        e: s,
                        opt: a,
        ...
        vt = function() {
            ...
            return r(t, [{
                ...
                value: function(t) {
                    ...
                    void 0 !== u && this.barCtx.isRangeBar && (w = u, L = u), void 0 !== g && this.barCtx.isVerticalGroupedRangeBar && (y = g, C = g);
                    var M = P.offsetX,
                        X = P.offsetY,
                        z = {
                            width: 0,
                    ...
                    return A = this.barCtx.isHorizontal ? this.calculateBarsDataLabelsPosition(Y) : this.calculateColumnsDataLabelsPosition(Y), f.attr({
                        cy: A.bcy,
                        cx: A.bcx,
                        j: o,
                        val: h[r][o],
                        ...
                        textRects: z,
                        dataLabelsConfig: P
                    }), x.config.chart.stacked && T.enabled && (S = this.drawTotalDataLabels({
                ...
                value: function(t) {
                    ...
                    this.barCtx.isVerticalGroupedRangeBar ? u += c / 2 : u = a.globals.isXNumeric ? h - c / 2 + y : h - A + c / 2 + y, k && (u = u + g.height / 2 - v / 2 - 2);
        ...
        yt = function() {
            ...
            return r(t, [{
                ...
                value: function(t, i) {
                    ...
                    a.config.dataLabels.enabled && (this.totalItems, this.barOptions.dataLabels.maxItems);
            ...
            return r(s, [{
                ...
                value: function(t, i, a) {
                    ...
                    for (var c = o.group({
                            ...
                            var n, h, d, g, u, p, f = void 0,
                                b = void 0,
                                v = [],
                                m = [],
                                y = r.globals.comboCharts ? a[i] : i,
                                w = o.group({
                                    class: "apexcharts-series",
                                    seriesName: x.escapeString(r.globals.seriesNames[y]),
                                    rel: i + 1,
                                    "data:realIndex": y
                                });
                            s.ctx.series.addCollapsedClassToSeries(w, y), t[i].length > 0 && (s.visibleI = s.visibleI + 1), s.yRatio.length > 1 && (s.yaxisIndex = y);
                            var k = s.barHelpers.initialPositions();
                            b = k.y, u = k.barHeight, h = k.yDivision, g = k.zeroW, f = k.x, p = k.barWidth, n = k.xDivision, d = k.zeroH, m.push(f + p / 2);
                            for (var A = o.group({
                                    class: "apexcharts-datalabels",
                                    "data:realIndex": y
                                }), S = function(a) {
                                    var o = s.barHelpers.getStrokeWidth(i, a, y),
                                        c = null,
                                        x = {
                                            indexes: {
                                                i: i,
                                    ...
                                    c = s.isHorizontal ? s.drawHorizontalBoxPaths(e(e({}, x), {}, {
                                        ...
                                        barWidth: p,
                                        zeroH: d
                                    })), b = c.y, f = c.x, a > 0 && m.push(f + p / 2), v.push(b), c.pathTo.forEach((function(e, n) {
                            ...
                            r.globals.seriesXvalues[y] = m, r.globals.seriesYvalues[y] = v, c.add(w)
            ...
            return r(t, [{
                ...
                value: function(t, i, a, s) {
                    ...
                    for (var c = [], d = 0; d < t.length; d++) {
                        ...
                        k = this.lineHelpers.determineFirstPrevY({
                            ...
                            prevY: k,
                            lineYPosition: 0
                        }).prevY, u.push(k), x = k, "rangeArea" === n && (v = A = this.lineHelpers.determineFirstPrevY({
                            i: d,
                            series: s,
                            prevY: A,
                            lineYPosition: 0
                ...
                value: function(t) {
                    ...
                    for (var M = n, X = 0; X < a; X++) {
                        ...
                        p = w.config.chart.stacked && r > 0 && w.globals.collapsedSeries.length < w.config.series.length - 1 ? this.prevSeriesY[function(t) {
                            ...
                            return e >= 0 ? e : 0
                        }(r - 1)][X + 1] : this.zeroY, z ? n = p - T / A[this.yaxisIndex] + 2 * (this.isReversed ? T / A[this.yaxisIndex] : 0) : (n = p - i[r][X + 1] / A[this.yaxisIndex] + 2 * (this.isReversed ? i[r][X + 1] / A[this.yaxisIndex] : 0), "rangeArea" === e && (M = p - y[r][X + 1] / A[this.yaxisIndex] + 2 * (this.isReversed ? y[r][X + 1] / A[this.yaxisIndex] : 0))), f.push(o), b.push(n);
            ...
            return r(t, [{
                ...
                value: function(t) {
                    ...
                    for (var v = g, m = 0; m < o; m++) {
                        l = "hour", p >= 24 && (p = 0, l = "day", b = h(f += 1, b).month, b = c(f, b));
                ...
                value: function(t, e) {
                    ...
                    if (s.comboCharts) {
                        ...
                        case "area":
                            ...
                            break;
                        case "bar":
                            a.chart.stacked ? v = new wt(this.ctx, e).draw(s.series) : (this.ctx.bar = new yt(this.ctx, e), v = this.ctx.bar.draw(s.series));
                            break;
                        case "candlestick":
        ...
        Ht = function() {
            ...
            return r(t, [{
                ...
                value: function(t, e) {
                    ...
                    return i.globals.axisCharts ? a = i.globals.dom.Paper.select("".concat(s, " path[j='").concat(e, "'], ").concat(s, " circle[j='").concat(e, "'], ").concat(s, " rect[j='").concat(e, "']")).members[0] : void 0 === e && (a = i.globals.dom.Paper.select("".concat(s, " path[j='").concat(t, "']")).members[0], "pie" !== i.config.chart.type && "polarArea" !== i.config.chart.type && "donut" !== i.config.chart.type || this.ctx.pie.pieClicked(t)), a ? (new m(this.ctx).pathMouseDown(a, null), a.node ? a.node : null) : null
                }
            }, {
        ...
        Wt = function() {
            ...
            return r(t, [{
                ...
                value: function(t, e) {
                    ...
                    var a = this.w.globals;
                    if (a.noData = !1, a.animationEnded = !1, this.responsive.checkResponsiveConfig(e), i.config.xaxis.convertedCatToNumeric && new z(i.config).convertCatToNumericXaxis(i.config, this.ctx), null === this.el) return a.animationEnded = !0, null;
