...
class MediaadminController extends Controller
{
    ...
    public function publicrelation()
    {
        ...
        $breadcrumb = [
            0 => ['title' => 'Home', 'message' => 'Home', 'status' => 0, 'link' => '/mediaadminhome'],
    ...
    public function createpublicrelation()
    {
        ...
        $breadcrumb = [
            0 => ['title' => 'Home', 'message' => 'Home', 'status' => 0, 'link' => '/mediaadminhome'],
            1 => ['title' => 'List Publicrelation', 'message' => 'List Publicrelation', 'status' => 0, 'link' => '/mediaadmin/publicrelation'],
            2 => ['title' => 'Upload Publicrelation Item', 'message' => 'Upload Publicrelation Item', 'status' => 2],
        ];
    ...
    public function viewpressrelpics(Request $request, $encid)
    {
        ...
        $breadcrumb = [
            0 => ['title' => 'Home', 'message' => 'Home', 'status' => 0, 'link' => '/mediaadmin/publicrelation'],
            1 => ['title' => 'Upload Publicrelation Item', 'message' => 'Upload Publicrelation Item', 'status' => 1],
        ];
        $breadcrumbarr = app('App\Http\Controllers\Commonfunctions')->bread_crump_maker($breadcrumb);
    ...
    public function tenderlist()
    {
        $breadcrumb = [
            0 => ['title' => 'Home', 'message' => 'Home', 'status' => 0, 'link' => '/mediaadminhome'],
            1 => ['title' => 'Tender', 'message' => 'Tender', 'status' => 1],
        ];
        $breadcrumbarr = app('App\Http\Controllers\Commonfunctions')->bread_crump_maker($breadcrumb);
        $navbar = app('App\Http\Controllers\Commonfunctions')->componentpermissionsetng();
        $user = app('App\Http\Controllers\Commonfunctions')->userinfo();
        ...
        $data = Tender::with(['tender_sub' => function ($query) {}])->get();
    ...
    public function createtender()
    {
        $breadcrumb = [
            0 => ['title' => 'Home', 'message' => 'Home', 'status' => 0, 'link' => '/mediaadminhome'],
            1 => ['title' => 'Tender list', 'message' => 'Tender list', 'status' => 1, 'link' => '/mediaadmin/tenderlist'],
            2 => ['title' => 'Tender', 'message' => 'Tender', 'status' => 2],
        ];
        $breadcrumbarr = app('App\Http\Controllers\Commonfunctions')->bread_crump_maker($breadcrumb);
        $navbar = app('App\Http\Controllers\Commonfunctions')->componentpermissionsetng();
        $user = app('App\Http\Controllers\Commonfunctions')->userinfo();
        ...
        $TenderType = TenderType::with(['tender_type_sub' => function () {}])->get();
    ...
    public function whatwedo()
    {
        ...
        $data = Whatwedo::with(['whatwedo_sub' => function ($query) {}])->get();
    ...
    public function createwhatwedo()
    {
        $breadcrumb = [
            0 => ['title' => 'Home', 'message' => 'Home', 'status' => 0, 'link' => '/mediaadminhome'],
            1 => ['title' => 'What we do list', 'message' => 'What we do list', 'status' => 1, 'link' => '/mediaadmin/whatwedo'],
            2 => ['title' => 'What we do', 'message' => 'What we do', 'status' => 2],
        ];
        $breadcrumbarr = app('App\Http\Controllers\Commonfunctions')->bread_crump_maker($breadcrumb);
        $navbar = app('App\Http\Controllers\Commonfunctions')->componentpermissionsetng();
        $user = app('App\Http\Controllers\Commonfunctions')->userinfo();
        ...
        $Whatwedotypes = Whatwedotype::with(['whatwedotype_sub' => function () {}])->get();

        $linktypes = Linktype::with(['linktype_sub' => function () {}])->get();
        $departments = Department::where('langcode', 1)->where('status', 1)->where('vid', 'departments')->orderBy('name')->get();
        ...
        try {
            ...
            if ($whatweid) {
                ...
                for ($i = 0; $i < $leng; $i++) {
                    ...
                    } elseif ($request->whatwedotype == 12) {
                        $store_sub_info = new WhatwedoSub([
                            'languageid' => $request->sel_lang[$i],
                            'title' => $request->title[$i],
                            'whatwedoid' => $whatweid,
