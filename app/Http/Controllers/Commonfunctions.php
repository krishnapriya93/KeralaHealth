...
class Commonfunctions extends Controller
{
        ...
        if (isset($breadcrump) && ! empty($breadcrump)) {
            if (is_array($breadcrump)) {
                foreach ($breadcrump as $crump) {
                    ...
                    } elseif (isset($crump['function']) && ! empty($crump['function'])) {
    ...
    {
        $langtitle = ['required', 'min:2', 'max:200', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    {
        $langtitle = ['required', 'min:2', 'max:1000000', 'not_regex:/\.\.\//'];
    ...
    {
        $langtitle = ['sometimes', 'nullable', 'min:2', 'max:200', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    {
        $langtitle = ['required', 'min:3', 'max:200', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    {
        $langtitle = ['min:2', 'max:50', 'sometimes', 'nullable', 'not_regex:/[#$^=]|\.\.\/|http/'];
    ...
    {
        $langtitle = ['min:2', 'max:200', 'sometimes', 'nullable', 'not_regex:/[#$^=]|\.\.\/|http/'];
    ...
    {
        $langtitle = ['required', 'min:3', 'max:200', 'not_regex:/[#$^=]|\.\.\/|http/'];
    ...
    {
        $langtitle = ['required', 'min:3', 'max:3000', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    {
        $langtitle = ['required', 'min:1', 'max:1000', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    {
        $langtitle = ['required', 'min:1', 'max:2000', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    {
        $langtitle = ['required', 'min:3', 'max:250', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    {
        $langtitle = ['required', 'min:3', 'max:50', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    {
        $langtitle = ['required', 'min:3', 'max:100', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    {
        $langtitle = ['required', 'min:3', 'max:500', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    {
        $langtitle = ['required', 'min:3', 'max:2000', 'regex:/^(?![\!-\/@\'\"\,&_.])(?!.*[\!-\/@\'\"\,&_.]{2})(?!.*[-\/@\'\"\,&_.]$)[a-zA-Z0-9\!\.\_\-\/\s@\'\"\,&]+$/'];
    ...
    {
        $langtitle = ['sometimes', 'nullable', 'min:3', 'max:2000', 'regex:/^(?![\!-\/@\'\"\,&_.])(?!.*[\!-\/@\'\"\,&_.]{2})(?!.*[-\/@\'\"\,&_.]$)[a-zA-Z0-9\!\.\_\-\/\s@\'\"\,&]+$/'];
    ...
    {
        $maltitlereg = ['sometimes', 'nullable', 'min:3', 'max:2000', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    {
        $maltitlereg = ['required', 'min:3', 'max:2000', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    {
        $maltitlereg = ['required', 'min:3', 'max:50', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    {
        $maltitlereg = ['required', 'min:3', 'max:100', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    {
        $maltitlereg = ['sometimes', 'nullable', 'min:3', 'max:1000', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    {
        $summernotereg = ['required', 'min:3', 'max:10000', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    {
        $summernotereg = ['required', 'min:3', 'max:5000', 'not_regex:/[#$^=]/'];
    ...
    {
        $summernotereg = ['required', 'min:3', 'max:2000', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    {
        $summernotereg = ['sometimes', 'nullable', 'min:3', 'max:20000', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    {
        $langtitle = ['required', 'min:2', 'max:150', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    {
        $langtitle = ['sometimes', 'nullable', 'min:1', 'max:300', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    {
        $langtitle = ['sometimes', 'nullable', 'min:3', 'max:200', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    {
        $langtitle = ['sometimes', 'nullable', 'min:2', 'max:20', 'regex:/^[a-zA-Z0-9 \s]+$/'];
    ...
    {
        $langtitle = ['required', 'min:2', 'max:20', 'regex:/^[a-zA-Z0-9 \s]+$/'];
    ...
    public function dropnumcheck()
    {
        $digitsonly = 'required|min:1|regex:/'.'^[0-9]+$'.'/';
    ...
    {
        $path = ['required', 'min:3', 'max:100', "regex:/^[a-zA-Z\/]+$/"];
    ...
    public function getpassword()
    {
        ...
        $pass = ['required', 'min:8', 'max:50', 'regex:/^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d@$!%*#?&^_-]{8,}$/'];
    ...
    public function get_pass_val()
    {
        ...
        $pass = ['required', 'min:6', 'max:50', 'required_with:cnfpassword', 'same:cnfpassword', 'regex:/^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d@$!%*#?&^_-]{8,}$/'];
    ...
    {
        //min:6|required_with:cnfpassword|same:cnfpassword
        $pass = ['required', 'min:6', 'max:50', 'required_with:password', 'same:password', 'regex:/^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d@$!%*#?&^_-]{8,}$/'];
    ...
    {
        //min:6|required_with:cnfpassword|same:cnfpassword
        $pass = ['sometimes', 'nullable', 'min:6', 'max:50', 'required_with:cnfpassword', 'same:cnfpassword', 'regex:/^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d@$!%*#?&^_-]{8,}$/'];
    ...
    {
        //min:6|required_with:cnfpassword|same:cnfpassword
        $pass = ['sometimes', 'nullable', 'min:6', 'max:50', 'required_with:password', 'same:password', 'regex:/^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d@$!%*#?&^_-]{8,}$/'];
    ...
    {
        $digit = ['sometimes', 'nullable', 'min:1', 'max:20', 'regex:/^[0-9]{1,20}$/'];
    ...
    {
        $digit = ['required', 'min:1', 'max:50', 'regex:/^[a-zA-Z0-9_]+$/'];
    ...
    {
        $color = ['sometimes', 'nullable', 'min:3', 'max:7', 'regex:/^#{1}([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/'];
    ...
    {
        $color = ['required', 'min:2', 'max:100', 'regex:/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=|\?v=)([^#\&\?]*).*/'];
    ...
    public function get_ckeditor_val_req_sometyms()
    {
        ...
        $ckval = ['sometimes', 'min:3', 'max:10000', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    public function get_ckeditor_val_req()
    {
        //to check 'not_regex:/(?:..\/)+/'
        //tags stripped at XSS -> kernal. Here only validation , 'not_regex:/[*#~\^]+|(\.\.\/\S)/'
        $ckval = ['required', 'min:3', 'max:10000', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    public function get_anchor_val_req()
    {
        ...
        $ancval = ['required', 'min:1', 'max:500', 'regex:/^[a-zA-Z0-9\s#]+$/'];
    ...
    public function get_anchor_val_not_req()
    {
        ...
        $ancval = ['sometimes', 'nullable', 'min:1', 'max:500', 'regex:/^[a-zA-Z0-9\s#]+$/'];
    ...
    public function get_engtitle_awards_req()
    {
        ...
        $ancval = ['required', 'min:3', 'max:500', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    public function get_duration_check()
    {
        ...
        $duration = ['required', 'min:5', 'max:6', 'regex:/^([0-1]?[0-9]?[0-9]|3[0-3]):[0-9][0-9]$/'];
    ...
    {
        $ancval = ['sometimes', 'nullable', 'min:3', 'max:500', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    public function get_ckeditor_val_not_req()
    {
        ...
        $ckval = ['sometimes', 'nullable', 'min:3', 'max:10000', 'not_regex:/[#$^=]|\.\.\//'];
    ...
    {
        $langtitle = ['sometimes', 'nullable', 'min:3', 'max:5000', 'not_regex:/[#$^=]|\.\.\//'];
